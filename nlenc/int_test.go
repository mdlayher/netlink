...
func TestInt64(t *testing.T) {
	...
	tests := []struct {
		...
		{
			v: 0x0102030401020304,
			b: []byte{0x04, 0x03, 0x02, 0x01, 0x04, 0x03, 0x02, 0x01},
		},
		{
			v: 0x1a2a3a4a1a2a3a4a,
			b: []byte{0x4a, 0x3a, 0x2a, 0x1a, 0x4a, 0x3a, 0x2a, 0x1a},
		},
		{
			v: -1,
		...
		{
			v: -2,
			b: []byte{0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff},
		},
	}
